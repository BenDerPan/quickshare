...
func after(duration int32) int32 {
	return int32(time.Now().Unix()) + duration
}
...
func NewBucket(resetCyc int32, cap int16) *Bucket {
	return &Bucket{
...
func (b *Bucket) Access(resetCyc int32, add int16) bool {
	now := now()
